  ...
  const projects = [
    {
      ...
      title: "RCG HisGrace",
      description:
        "A modern church website featuring event management, sermon archives, and community engagement features. Built with a focus on user experience and responsive design.",
      image: "/project-hisgrace.jpg",
      technologies: [
        "React",
        "Node.js",
        "MongoDB",
    ...
    },
    {
      ...
      features: ["Responsive Design", "Career Guidance"],
    },
  ];
